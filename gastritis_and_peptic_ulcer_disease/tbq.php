...
<?php include '../includes/head.inc.php'; ?>
  <body>
	...
	<div class="container">
		<div class="row">
	        <div class="col-xs-12">
				<h1>Gastric and Peptic Ulcer Disease Application Questions</h1>
		        <div class="col-xs-8">
			        <div class="tbq">
				        <ol class="questions"></ol>
				        <h3>Case one</h3>
				        <p>The patient, a 74 year old lady, who presented to her Primary Physician for a very gradual onset of shortness of breath and fatigue.</p>
						<p>The patient's daughter who accompanied her to the visit told the Primary Physician that over the past year her mother was eating less, was in general more disinterested in her surroundings and was getting very forgetful.  She had lost about 10 lbs over this period of time.</p> 
						...
						<ul>
							<li>Hb:  6.9 g/dl (11.6 to 15.6)     Hct:  20.6% (34.8 to 46.6)</li>
							<li>MCV:  106 fL (79.0 - 93.3)   RDW:  17% (&lt; 14.5)</li>
							<li>WBC:  3.0 x 109/L (3.5 to 10.8)</li>
							<li>Platelet count:  154 x  109/L (169 - 358)</li>
							<li>Blood Smear:  see next slide</li>
						</ul>
						...
						<h3>Questions</h3>
						<p>What was the type of anemia that the patient had?</p>
