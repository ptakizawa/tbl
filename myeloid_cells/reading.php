	        ...
	        <div class="col-xs-12">
	         	<div class="blog-post">
					...
					<p>The first step in evaluating this patient's leukocytosis is to determine which blood cell type is elevated -  in this case, neutrophils. The second step is to determine whether the neutrophilia seen here is due to a primary or secondary cause. Primary causes of neutrophilia arise when there is a primary hematologic or bone marrow problem giving rise to a high neutrophil count. A primary neutrophilia might result from a hematopoietic defect due to clonal overproduction of neutrophils, which can be seen in some types of leukemias or similar disorders known as myeloproliferative neoplasms. By contrast, secondary neutrophilia arises when there is an exogenous stimulus that promotes normal albeit accelerated neutrophil production and release from the bone marrow, or that increases intravascular demargination of neutrophils. The major causes of secondary neutrophilia are infections (which tend to give rise to not only an increase in mature circulating neutrophils, but also a rise in circulating bands, a.k.a. "bandemia") or medications, particularly steroids (which increase neutrophil demargination from the vascular wall) or lithium (which causes increased levels of granulocyte colony stimulating factor (G-CSF)).</p>
						...
						<ul>
							<li>A patient with eosinophilia might have incurred this as a result of a primary problem in the bone marrow, e.g., hypereosinophilic syndrome (due to a gene translocation involving PDGFR and FIP1L1 genes), or a secondary process such as an allergic reaction or a parasitic infection.</li>
							<li>A patient with monocytosis might have a primary problem in the bone marrow such as chronic myelomonocytic leukemia (defined as an unexplained, persistent monocytosis over a 3 month period), or a secondary process such as an infection (e.g., tuberculosis), an autoimmune or inflammatory disease (e.g., sarcoidosis), splenectomy, or a bone marrow that is recovering from a prior aplastic insult (e.g., from recent chemotherapy).</li>
							<li>A patient with basophilia might have a primary problem in the bone marrow, most commonly a myeloproliferative neoplasm (e.g., polycythemia vera, chronic myeloid leukemia), or less commonly there may be a secondary basophilia arising in the setting of a drug allergy.</li>
						</ul>
						<p>Lastly, in order to understand some aspects of this lab, and as a preview for the clinicopathologic conferences (CPC) that will comprise the bulk of the malignant hematology lectures, we should discuss a few key concepts that underlie the myeloid cancers in hematology.</p>
						<ul>
